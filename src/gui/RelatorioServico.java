...
public class RelatorioServico extends javax.swing.JFrame {
    ...
    private controller.ControleServico controleServico;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Relatório de Serviço");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            listFuncao.setListData(controleServico.listarTodos().toArray());
        } catch (SQLException ex) {
            Logger.getLogger(RelatorioServico.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            File arquivo = fileChooser.getSelectedFile();
                try {
                    controleServico.createPdf(arquivo.getPath().contains(".pdf") ? arquivo.getPath() : arquivo.getPath() + ".pdf");
